	 			...
	 			<div class="col-md-6 mt-4 p-5  rounded " style="background-color:#D3DEDC">
	 				...
	 				<form method="post">
	 					...
	 					<div class="form-group">
	 						...
	 						<input type="text" name="uname" class="form-control" autocomplete="off" placeholder="Enter Username" value="<?php  
	 						                   if(isset($_POST['uname'])) {echo $_POST['uname'];} ?>">
	 					</div>
	 					<div class="form-group">
	 						<label>Email</label>
	 						<input type="email" name="email" class="form-control" autocomplete="off" placeholder="Enter Email Address" value="<?php  
	 					...
	 					<div class="form-group">
	 						...
	 						<input type="password" name="con_pass" autocomplete="off" class="form-control" placeholder="Enter Confirm Password">
	 					</div>
