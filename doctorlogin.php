...
<body style="background-image:url(img/backg.jpg); , background-size: cover;, background-repeat: no-repeat;">
	 ...
	 <div class="container-fluid">
	 	<div class="col-md-12">
	 		<div class="row">
	 			...
	 			<div class="col-md-6 mt-4 p-5  rounded my-3" style="background-color:#D3DEDC">
